"""Build the LangGraph workflow shown in the docs architecture."""
...
def build_graph():
    """Create the 7-node stock analysis graph.

    Flow:
    user input -> Planner -> parallel specialist layer -> Decision -> Reflection
